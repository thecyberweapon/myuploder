...
If bot didn't respond, contact @xgorn"""
    ...
    SLOW_URL_DECED = "Gosh that seems to be a very slow URL. Since you were screwing my home, I am in no mood to download this file. Meanwhile, why don't you try this:==> http://B34STX.tk and get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
